if instance_exists(selector_inst)
{
	with (selector_inst)
	{
		...
		draw_sprite_ext(spr_selector, other.selector_frame, bbox_right, bbox_bottom, 1, 1, -90, -1, 1);
		draw_sprite_ext(spr_selector, other.selector_frame, bbox_right, bbox_bottom, 1, 1, 180, -1, 1);
		draw_sprite_ext(spr_selector, other.selector_frame, bbox_left, bbox_top, 1, 1, 90, -1, 1);
	}
