			...
			if _key_press
			{
				if state = "HARVEST"
				{
					switch (object_get_name(object_index)) 
					{
						...
						{
							obj_inventory.inventory.item_add("Space Dust", 1, spr_space_dust, false, "crafting", "CRAFTING REAGENT\n");
						...
						{
							obj_inventory.inventory.item_add("Clay Crust", 1, spr_clay_crust, false, "crafting", "CRAFTING REAGENT\n");
							show_debug_message("Added Space Crust to inventory."); // Debug message
							show_debug_message("Inventory Contents: " + string(obj_inventory.inventory.item_get()));
						} break;
						case "obj_sun_flower":
						{
							obj_inventory.inventory.item_add("Solar Juice", 1, spr_solar_juice, false, "crafting", "CRAFTING REAGENT\n");
							show_debug_message("Added Solar Juice to inventory."); // Debug message
							show_debug_message("Inventory Contents: " + string(obj_inventory.inventory.item_get()));
						} break;
						case "obj_hell_flame":
						{
							obj_inventory.inventory.item_add("THC", 1, spr_thc, false, "crafting", "CRAFTING REAGENT\n");
